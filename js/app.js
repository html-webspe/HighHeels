(() => {
    ...
    function menuInit() {
        if (document.querySelector(".menu__action")) document.addEventListener("click", (function(e) {
            ...
            const gg = document.querySelector(".icon-menu__text");
            document.documentElement.classList.contains("menu-open") ? gg.innerHTML = "закрити" : gg.innerHTML = "меню";
        }));
    }
    function menuClose() {
        bodyUnlock();
    ...
    function initSliders() {
        if (document.querySelector(".trainer__slider")) new core(".trainer__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".shorts__slider")) new core(".shorts__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            lazy: true,
            navigation: {
                prevEl: ".shorts__button-prev",
                nextEl: ".shorts__button-next"
            }
        });
    }
    ...
    checkboxInput.forEach((element => {
        element.addEventListener("change", (function() {
            const th = element;
            const formButton = th.closest("form").querySelector(".form__button");
